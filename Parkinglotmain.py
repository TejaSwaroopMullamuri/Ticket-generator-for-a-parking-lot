...
while True:
    ...
    if car_park_un.lstrip().upper() == "YES":
        ...
        un_lot = input(">>> ")
        AF.unavailable_lots_for_cars(un_lot, pl_for_cars, floors_for_cars, columns_for_cars, rows_for_cars)
        print(pl_for_cars)
...
while True:
    ...
    if bike_park_un.lstrip().upper() == "YES":
        ...
        print("Please avoid any spaces and enter the commas too")
        un_lot_bike = input(">>> ")
        AF.unavailable_lots_for_bikes(un_lot_bike, pl_for_bikes, floors_for_bikes, columns_for_bikes, rows_for_bikes)
                        ...
                        if car_number.lstrip() == "x":
                            ...
                            for i in range(0, 120000):
                                if i % 120000 == 0:
                                    ...
                                    print(visit_again[int(i / 120000)], end="")
                            print()
                        ...
                        if bike_number.lstrip() == "x":
                            ...
                            for i in range(0, 120000000):
                                ...
                                if i % 1000000 == 0:
                                    ...
                                    print(visit_again[int(i / 1000000)], end="")
